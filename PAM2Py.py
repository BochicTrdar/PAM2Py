...
def gui_metanum():    
    ...
    if ( ngui > 1 ): 
       ...
       ttk.Label(Gmetanum,text='Documentation:'     ,style='TE2.TLabel').grid(column=1,row=13)
       ttk.Label(Gmetanum,text='Metadata_Format.pdf',style='TE2.TLabel').grid(column=2,row=13)
       ttk.Button(Gmetanum, text="Write", style='CB.TButton', command=writenum).grid(column=4, row=12, padx=5, pady=5)
       ttk.Button(Gmetanum, text="Close", style='CB.TButton', command=lambda:[jmdn.set(0),Gmetanum.grab_release(),Gmetanum.destroy()]).grid(column=4, row=13, padx=5, pady=5)
    return
#======================================================================
...
def gui_metaexp():
    ...
    if ( ngui > 1 ): 
       ...
       ttk.Label(Gmetaexp,text='Documentation:'     , style='TE2.TLabel').grid(column=3,row=20)
       ttk.Label(Gmetaexp,text='Metadata_Format.pdf', style='TE2.TLabel').grid(column=4,row=20)
#      Buttons:
...
#   YUP, I prefer file extensions this way:
    ...
    if ( j == 0 ):
       ...
       thesignal, Fs = sf.read(thedir+'/'+list_of_files[0],dtype=float64)
       Hcut.set(Fs//2)       
    return
#======================================================================
...
te2 = ttk.Style()
te2.configure('TE2.TLabel', font=('Helvetica', 12, 'bold'), anchor='center')
# Main GUI:
...
thelogo = PhotoImage(file="Logos/jonas_logo.png")
...
ttk.Radiobutton(mainframe, text="Model Generated Data", style='RE.TRadiobutton', variable=gui2open, value='GND')
